...
################################################################
# Step 1: Read and merge Train and Test data sets. Proceed through the merged data.
################################################################

# assembling train and test sets.

train = pd.read_csv("/Users/macbook/Desktop/miul/Miuul/6. hafta machine learning/ödevler/untitled folder/HousePrice/data/train.csv")
test = pd.read_csv("/Users/macbook/Desktop/miul/Miuul/6. hafta machine learning/ödevler/untitled folder/HousePrice/data/test.csv")
...
# Filling the gaps in the columns with “No”
for col in no_cols:
...
######################################
# Analyze Rare and apply rare encoder.
######################################
...
######################################
# Create new variables and add 'NEW' at the beginning of the new variables you create.
######################################
...
##################
# BONUS : Build a model by log transformation and observe the rmse results.
# Not: Do not forget to take the inverse of the log.
##################
...
################################################################
# Plot the ranking of the features using the feature_importance function that specifies the importance level of the variables.
################################################################
